 ...
 *
 * @param queue_out_in  Pointer to queue structure for out.
 * @param queue_in_in   Pointer to queue structure for in.
 *
 * @return 0 if successful, error otherwise
 */
int audio_usb_start(struct k_msgq *queue_out_in, struct k_msgq *queue_in_in);
