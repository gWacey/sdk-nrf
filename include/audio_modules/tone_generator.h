 ...
 *
 */
extern struct audio_module_description *audio_module_tone_generator_description;

/**
 * @brief The module configuration structure.
 *
 */
struct audio_module_tone_generator_configuration {
 ...
 *
 */
struct audio_module_tone_generator_context {
