...
#define TEST_AUDIO_DATA_BLOCKS	    4

#define TEST_AUDIO_CHANNELS_MAX 6

#define TEST_AUDIO_MONO_LEFT_CHANNEL_MAP  (AMOD_CHANNEL_LEFT_FRONT)
#define TEST_AUDIO_MONO_RIGHT_CHANNEL_MAP (AMOD_CHANNEL_RIGHT_FRONT)
#define TEST_AUDIO_STEREO_CHANNEL_MAP	  (AMOD_CHANNEL_LEFT_FRONT | AMOD_CHANNEL_RIGHT_FRONT)
#define TEST_AUDIO_MULTI_CHANNEL_MAP                                                               \
	(AMOD_CHANNEL_LEFT_FRONT | AMOD_CHANNEL_RIGHT_FRONT | AMOD_CHANNEL_CENTRE |                \
	 AMOD_CHANNEL_LFE | AMOD_CHANNEL_LEFT_BACK | AMOD_CHANNEL_RIGHT_BACK)
